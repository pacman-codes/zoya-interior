      ...
      <div className="grid w-full gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <div>
          <div className="mb-8 flex items-center gap-6">
            <p className="shrink-0 text-xs uppercase tracking-[0.2em] text-[var(--tone-dark)]">
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-[var(--tone-dark)]">
            {isRu
        ...
        <form className="mx-auto w-full max-w-xl space-y-7">
          <label className="block">
            ...
            <input
              ...
              className="w-full border-b border-[var(--line-soft)] bg-transparent py-4 text-xl text-[var(--tone-muted)] outline-none transition placeholder:text-[var(--tone-muted)] focus:border-[var(--tone-dark)] focus:text-[var(--tone-dark)]"
            />
          </label>
          ...
          <button
            type="submit"
            className="mt-2 inline-flex rounded-full bg-[var(--tone-dark)] px-8 py-4 text-sm text-white transition hover:translate-y-[-2px] hover:opacity-90"
          >
